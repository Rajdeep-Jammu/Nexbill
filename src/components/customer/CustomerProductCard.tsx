        ...
        <CardContent className="p-0 flex flex-col flex-grow">
          <div className="relative overflow-hidden aspect-[4/5]">
            ...
            <div className="absolute top-2 left-2 flex flex-col gap-1 sm:top-4 sm:left-4 sm:gap-2">
              {stock <= 0 ? (
                <Badge variant="destructive" className="font-bold text-[8px] sm:text-xs uppercase px-1.5 py-0 shadow-lg">Sold Out</Badge>
              ) : stock <= 5 ? (
                <Badge className="bg-orange-500 font-bold text-[8px] sm:text-xs uppercase px-1.5 py-0 shadow-lg">Limited</Badge>
              ) : null}
            </div>
          ...
          <div className="p-2 sm:p-5 flex flex-col flex-grow bg-card/60 backdrop-blur-md">
            <h3 className="font-headline font-bold text-[10px] sm:text-base line-clamp-1">
              {product.name}
            </h3>
